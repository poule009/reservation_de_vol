...
<head>
    ...
    @else
    <style>
        /* pour le style je les trouver sur internet meme je pense que c evident */
        @layer theme {
...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        ...
        <nav class="flex items-center justify-end gap-4">
            ...
            <a href="{{ route('login') }}"
                class="inline-flex items-center justify-center px-8 py-4 border-2 border-[#19140035] dark:border-[#3E3E3A] text-[#1b1b18] dark:text-[#EDEDEC] font-semibold rounded-xl hover:bg-[#1b1b18] hover:text-white dark:hover:bg-[#EDEDEC] dark:hover:text-[#1b1b18] transition-all duration-200">
    ...
    <!-- Hero Section -->
    <div class="w-full lg:max-w-4xl max-w-[335px] text-center">
        <div class="mb-8">
            <h1 class="text-4xl lg:text-6xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-6 leading-tight">
                Réservez votre vol en toute simplicité
            </h1>
            <p class="text-lg lg:text-xl text-[#706f6c] dark:text-[#A1A09A] mb-8 leading-relaxed">
                Découvrez des milliers de destinations à travers le monde. Réservez vos billets d'avion en quelques clics avec notre plateforme sécurisée.
            </p>

            <!-- Call to Action Buttons -->
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <a href="{{ route('flights.index') }}"
                    class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 transition-all duration-200 shadow-lg">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div class="bg-white dark:bg-[#161615] rounded-2xl p-6 shadow-lg border border-[#e3e3e0] dark:border-[#3E3E3A] hover:shadow-xl transition-all duration-300 animate-fade-in-up" style="animation-delay: 0.2s; animation-fill-mode: both;">
                <div class="bg-blue-100 dark:bg-blue-900 rounded-full w-12 h-12 flex items-center justify-center mb-4 animate-bounce" style="animation-delay: 0.5s; animation-duration: 2s;">
                    <svg class="w-6 h-6 text-blue-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                    </svg>
                </div>
                <h3 class="text-xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC] mb-2">Recherche facile</h3>
                <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm leading-relaxed">
                    Trouvez rapidement le vol parfait grâce à notre moteur de recherche intuitif et nos filtres avancés.
                </p>
            </div>

            
            <div class="bg-white dark:bg-[#161615] rounded-2xl p-6 shadow-lg border border-[#e3e3e0] dark:border-[#3E3E3A] hover:shadow-xl transition-all duration-300 animate-fade-in-up" style="animation-delay: 0.4s; animation-fill-mode: both;">
                <div class="bg-green-100 dark:bg-green-900 rounded-full w-12 h-12 flex items-center justify-center mb-4 animate-pulse" style="animation-delay: 0.7s; animation-duration: 3s;">
                    <svg class="w-6 h-6 text-green-600 dark:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
                <h3 class="text-xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC] mb-2">Réservation sécurisée</h3>
                <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm leading-relaxed">
                    Bénéficiez d'un processus de réservation sécurisé avec paiement en ligne et confirmation instantanée.
                </p>
            </div>

            
            <div class="bg-white dark:bg-[#161615] rounded-2xl p-6 shadow-lg border border-[#e3e3e0] dark:border-[#3E3E3A] hover:shadow-xl transition-all duration-300 animate-fade-in-up" style="animation-delay: 0.6s; animation-fill-mode: both;">
                <div class="bg-purple-100 dark:bg-purple-900 rounded-full w-12 h-12 flex items-center justify-center mb-4 animate-spin" style="animation-delay: 0.9s; animation-duration: 4s;">
                ...
                <h3 class="text-xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC] mb-2">Support 24/7</h3>
                <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm leading-relaxed">
                    Notre équipe est disponible 24h/24 pour vous accompagner dans votre voyage et répondre à vos questions.
                </p>
            </div>
        </div>

        <!-- Stats Section -->
        <div class="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-8 mb-8 border border-indigo-100 dark:border-indigo-800">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                    <div class="text-3xl font-bold text-indigo-600 dark:text-indigo-400 mb-2">500+</div>
                    <div class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Destinations</div>
                </div>
                <div>
                    <div class="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">10K+</div>
                    <div class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Vols quotidiens</div>
                </div>
                <div>
                    <div class="text-3xl font-bold text-pink-600 dark:text-pink-400 mb-2">50K+</div>
                    <div class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Clients satisfaits</div>
                </div>
                <div>
                    <div class="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">99.9%</div>
                    <div class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Taux de ponctualité</div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center">
            ...
            <p class="text-[#706f6c] dark:text-[#A1A09A] mb-6">
                Rejoignez des milliers de voyageurs qui nous font confiance pour leurs déplacements.
            </p>
            <a href="{{ route('flights.index') }}"
                class="inline-flex items-center justify-center px-8 py-4 bg-black text-white font-semibold rounded-xl hover:bg-gray-900 transform hover:scale-105 transition-all duration-200 shadow-lg">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
