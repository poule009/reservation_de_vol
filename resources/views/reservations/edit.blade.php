...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <a href="{{ route('reservations.show', $reservation) }}" class="text-gray-500 hover:text-gray-700">{{ $reservation->passenger_first_name }} {{ $reservation->passenger_last_name }}</a>
            </li>
            <li>
                <span class="text-gray-400 mx-2">/</span>
            </li>
    ...
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Modifier la réservation</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ old('passenger_first_name', $reservation->passenger_first_name) }}"
                           required
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ old('passenger_last_name', $reservation->passenger_last_name) }}"
                           required
                ...
                <div>
                    ...
                    <input type="tel"
                           ...
                           id="passenger_phone"
                           value="{{ old('passenger_phone', $reservation->passenger_phone) }}"
                ...
                <div>
                    ...
                    <input type="email"
                           ...
                           id="passenger_email"
                           value="{{ old('passenger_email', $reservation->passenger_email) }}"
